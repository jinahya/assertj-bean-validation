...
@DisplayName("isNotValidFor")
@Slf4j
class User_IsNotValidFor_Test {

    @DisplayName("valid name isNotValidFor User#name throws AssertionError")
    @Test
    void __ValidName() {
        {
    ...
    @DisplayName("invalid name isNotValidFor User#name does not throw")
    @Test
    void __InvalidName() {
        {
