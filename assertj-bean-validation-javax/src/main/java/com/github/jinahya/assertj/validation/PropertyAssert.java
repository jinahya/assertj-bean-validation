...
/**
 * An interface for verifying values against properties of specific bean types.
 *
...
public interface PropertyAssert<SELF extends PropertyAssert<SELF, ACTUAL>, ACTUAL>
     ...
     * @param <T>          type of the bean
     * @return this assertion instance.
     * @apiNote Note that the {@link javax.validation.Valid} is not honored by the {@link Validator#validateValue(Class,
     * String, Object, Class[])} method on which this method relies.
